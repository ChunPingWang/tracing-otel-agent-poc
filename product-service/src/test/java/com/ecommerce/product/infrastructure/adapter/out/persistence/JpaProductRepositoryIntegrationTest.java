...
@Sql(statements = {
    "MERGE INTO products (product_id, name, price, available) KEY(product_id) VALUES ('P001', '無線藍牙耳機', 995.00, true)",
    "MERGE INTO products (product_id, name, price, available) KEY(product_id) VALUES ('P002', 'USB-C 充電線', 299.00, true)"
})
